      ...
      <div className="rounded-2xl bg-white p-6 shadow dark:bg-black dark:shadow-dark lg:col-span-2 lg:p-10">
        <div>
          ...
          <p className="mt-2 text-lg text-muted dark:text-light/70">
            Dive into my portfolio and discover a world of innovative solutions
          </p>
        </div>
        ...
        <div className="mt-10 lg:mt-14">
              ...
              <div key={project.id}>
                <div className="relative">
                  ...
                  <div className="absolute bottom-4 left-4 flex flex-wrap gap-2">
                    {project.tags.map((tag) => (
                      <span
                        key={tag}
                        className="inline-flex items-center justify-center gap-2 rounded bg-black px-2 py-1 text-center text-xs leading-none text-white shadow transition hover:bg-primary hover:text-white"
                      >
                        {tag}
                      </span>
                    ))}
                ...
                <div className="mt-6">
                  ...
                  <ul className="mt-4 flex flex-wrap items-center gap-2">
                    <li className="text-sm text-muted/50">{project.url}</li>
                  </ul>
                </div>
              </div>
            ))}
          ...
          {/* <nav className="mt-10 flex items-center justify-center gap-1.5">
            ...
            <button type="button" className={paginationButtonClass} aria-current="page">
              1
            </button>
            <button type="button" className={paginationButtonClass}>2</button>
            <button type="button" className={paginationButtonClass}>3</button>
            <button type="button" className={paginationButtonClass}>100</button>
